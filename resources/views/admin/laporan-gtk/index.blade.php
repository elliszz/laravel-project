                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if($item->folder_bukti && Str::startsWith($item->folder_bukti, ['http://','https://']))
                                    <a href="{{ $item->folder_bukti }}" target="_blank" class="icon-doc bg-doc-1">
                            ...
                            <td class="text-center">
                                @if($item->bukti_akademik && Str::startsWith($item->bukti_akademik, ['http://','https://']))
                                    <a href="{{ $item->bukti_akademik }}" target="_blank" class="icon-doc bg-doc-2">
                            ...
                            <td class="text-center">
                                @if($item->bukti_keuangan && Str::startsWith($item->bukti_keuangan, ['http://','https://']))
                                    <a href="{{ $item->bukti_keuangan }}" target="_blank" class="icon-doc bg-doc-3">
                            ...
                            <td class="text-center text-nowrap">
                                <a href="{{ route('admin.laporan-gtk.edit', $item->id) }}" class="btn btn-sm btn-warning">
...
{{-- SCRIPT SEARCH SEMUA KOLOM (VIEW SAJA) --}}
<script>
