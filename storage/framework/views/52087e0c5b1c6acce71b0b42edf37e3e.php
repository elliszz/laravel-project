                ...
                <table class="table table-bordered table-hover align-middle table-gtk">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center text-nowrap"><?php echo e(\Carbon\Carbon::parse($item->tanggal)->format('d-m-Y')); ?></td>
                            ...
                            <td class="text-center">
                                <?php if($item->folder_bukti && Str::startsWith($item->folder_bukti, ['http://','https://'])): ?>
                                    <a href="<?php echo e($item->folder_bukti); ?>" target="_blank" class="icon-doc bg-doc-1" title="📂 Folder Bukti"><i class="bi bi-folder-fill"></i></a>
                                <?php else: ?>
                            ...
                            <td class="text-center">
                                <?php if($item->bukti_akademik && Str::startsWith($item->bukti_akademik, ['http://','https://'])): ?>
                                    <a href="<?php echo e($item->bukti_akademik); ?>" target="_blank" class="icon-doc bg-doc-2" title="📄 Bukti Akademik"><i class="bi bi-file-earmark-text"></i></a>
                                <?php else: ?>
                            ...
                            <td class="text-center">
                                <?php if($item->bukti_keuangan && Str::startsWith($item->bukti_keuangan, ['http://','https://'])): ?>
                                    <a href="<?php echo e($item->bukti_keuangan); ?>" target="_blank" class="icon-doc bg-doc-3" title="💰 Bukti Keuangan"><i class="bi bi-cash-coin"></i></a>
                                <?php else: ?>
                            ...
                            <td class="text-center text-nowrap">
                                <a href="<?php echo e(route('admin.laporan-gtk.edit', $item->id)); ?>" class="btn btn-sm btn-warning"><i class="bi bi-pencil-square"></i></a>
                        ...
                        <tr>
                            <td colspan="<?php echo e(auth()->user()->role === 'admin' ? 13 : 12); ?>" class="text-center text-muted">Data belum ada</td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\master-data-ppg\resources\views/user/laporan-gtk/index.blade.php ENDPATH**/ ?>